...
func RegistroPost(w http.ResponseWriter, r *http.Request) {
	...
	cliente := &http.Client{}
	req, _ := http.NewRequest("POST", "https://mi-proyecto-auth.onrender.com/autenticacion/registrar", bytes.NewBuffer(jsonValue))
...
func InicioSesionEnviar(w http.ResponseWriter, r *http.Request) {
	...
	cliente := &http.Client{}
	req, _ := http.NewRequest("POST", "https://mi-proyecto-auth.onrender.com/autenticacion/iniciarSesion", bytes.NewBuffer(jsonValue))
	req.Header.Set("Content-Type", "application/json")
...
func PerfilEditado(w http.ResponseWriter, r *http.Request) {
	...
	jsonValue, _ := json.Marshal(datos)
	cliente := &http.Client{}
	req, _ := http.NewRequest("PUT", "https://mi-proyecto-auth.onrender.com/autenticacion/EditarPerfil", bytes.NewBuffer(jsonValue))
	req.Header.Set("Content-Type", "application/json")
...
func enviarPedidoHTTP(pedido model.Pedido) error {
	...
	url := "https://mi-proyecto-pedido.onrender.com/registro"
